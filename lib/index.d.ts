...
export declare const getProjectNamespace: (name?: string, prefix?: string) => string;
...
declare class ManagementV1DevPodWorkspaceInstanceTroubleshoot {
	/**
	* APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
	*/
	"apiVersion"?: string;
...
declare class StorageV1NodeProviderPods {
	/**
...
declare class StorageV1Requirement {
	"complement"?: boolean;
	"greaterThan"?: number;
	"key"?: string;
	"lessThan"?: number;
...
declare class StorageV1Offering {
	/**
	...
	*/
	"requirements"?: {
		[key: string]: StorageV1Requirement;
	};
	static readonly discriminator: string | undefined;
	static readonly attributeTypeMap: Array<{
		name: string;
