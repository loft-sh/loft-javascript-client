...
*/
export class ClusterV1LocalClusterAccess {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "spec",
            "baseName": "spec",
            "type": "ClusterV1LocalClusterAccessSpec",
            "format": ""
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ClusterV1LocalClusterAccessStatus",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ClusterV1LocalClusterAccess.attributeTypeMap;
    }
