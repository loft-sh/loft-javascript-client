...
import { StorageV1DevPodWorkspaceTemplateSpec } from '../models/storageV1DevPodWorkspaceTemplateSpec';
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "spec",
            "baseName": "spec",
            "type": "StorageV1DevPodWorkspaceTemplateSpec",
            "format": ""
        },
        {
            "name": "status",
    ...
    static getAttributeTypeMap() {
        return StorageV1DevPodWorkspaceTemplate.attributeTypeMap;
    }
