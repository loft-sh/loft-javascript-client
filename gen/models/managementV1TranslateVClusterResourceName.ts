...
*/
export class ManagementV1TranslateVClusterResourceName {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "spec",
            "baseName": "spec",
            "type": "ManagementV1TranslateVClusterResourceNameSpec",
            "format": ""
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ManagementV1TranslateVClusterResourceNameStatus",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ManagementV1TranslateVClusterResourceName.attributeTypeMap;
    }
