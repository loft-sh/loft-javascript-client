...
*/
export class ManagementV1SpaceConstraint {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "spec",
            "baseName": "spec",
            "type": "ManagementV1SpaceConstraintSpec",
            "format": ""
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ManagementV1SpaceConstraintStatus",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ManagementV1SpaceConstraint.attributeTypeMap;
    }
