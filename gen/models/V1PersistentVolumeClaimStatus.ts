    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "type": "Array<V1PersistentVolumeClaimStatusAccessModesEnum>",
            "format": ""
        },
        {
        ...
        },
        {
            "name": "phase",
            "baseName": "phase",
            "type": "V1PersistentVolumeClaimStatusPhaseEnum",
            "format": ""
        }    ];
...
export enum V1PersistentVolumeClaimStatusAllocatedResourceStatusesEnum {
    ControllerResizeInProgress = 'ControllerResizeInProgress',
    ControllerResizeInfeasible = 'ControllerResizeInfeasible',
    NodeResizeInProgress = 'NodeResizeInProgress',
    NodeResizeInfeasible = 'NodeResizeInfeasible',
    NodeResizePending = 'NodeResizePending'
}
export enum V1PersistentVolumeClaimStatusPhaseEnum {
    Bound = 'Bound',
    Lost = 'Lost',
    Pending = 'Pending'
}
