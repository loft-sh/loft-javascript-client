    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "type": "V1TopologySpreadConstraintWhenUnsatisfiableEnum",
            "format": ""
        }    ];
...
export enum V1TopologySpreadConstraintNodeAffinityPolicyEnum {
    Honor = 'Honor',
    Ignore = 'Ignore'
}
export enum V1TopologySpreadConstraintNodeTaintsPolicyEnum {
    Honor = 'Honor',
    Ignore = 'Ignore'
}
export enum V1TopologySpreadConstraintWhenUnsatisfiableEnum {
