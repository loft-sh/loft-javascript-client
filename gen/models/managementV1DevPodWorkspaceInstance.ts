...
*/
export class ManagementV1DevPodWorkspaceInstance {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "spec",
            "baseName": "spec",
            "type": "ManagementV1DevPodWorkspaceInstanceSpec",
            "format": ""
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ManagementV1DevPodWorkspaceInstanceStatus",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ManagementV1DevPodWorkspaceInstance.attributeTypeMap;
    }
